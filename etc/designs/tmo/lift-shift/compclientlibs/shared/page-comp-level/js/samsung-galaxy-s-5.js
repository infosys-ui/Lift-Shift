$(document).ready(function() {
	...
	********************************************************/
	...
	function affixFeature() {
		...
		var referenceContent = $('.float-div');
		var topLine = referenceContent.offset().top;
		var bottomOffLine = docHeight - (referenceContent.offset().top + referenceContent.outerHeight());
		console.log(topLine, bottomOffLine);
		//bottomOffLine = 2568;
